...
Các số liệu và case trong sách được ghi rõ nguồn trong [Phụ lục C](12-Phu-luc-C-chi-muc-case-va-nguon-tai-lieu.md). Nếu phát hiện thiếu sót hoặc sai lệch, vui lòng mở Issue để cùng cải thiện bản dịch.
...
- **Đọc bản dịch:** Các chương tiếng Việt nằm trong thư mục [`vi/`](vi/).
- **Tải toàn bộ bản dịch (định dạng PDF):** [FDE-Bi-Quyet-Deliver-Gia-Tri-Khach-Hang-Trong-Thoi-Dai-AI.pdf](<FDE-Bi-Quyet-Deliver-Gia-Tri-Khach-Hang-Trong-Thoi-Dai-AI.pdf>) — bản PDF tiếng Việt được ghép từ các chương; nếu có khác biệt, ưu tiên nội dung Markdown của từng chương.
...
| [Chương 4](04-Chuong-4-kich-hoat-deploy.md) | Kích hoạt deployment |
| [Chương 5](05-Chuong-5-giu-vung-renewal.md) | Giữ vững renewal |
| [Chương 6](06-Chuong-6-mo-rong-doanh-thu.md) | Mở rộng doanh thu |
| [Chương 7](07-Chuong-7-nhan-rong-o-quy-mo.md) | Nhân rộng ở quy mô lớn |
| [Chương 8](08-Chuong-8-tuyen-tap-case.md) | Tuyển tập các case hoàn chỉnh |
| [Lời bạt](09-Chuong-9-loi-bat-dao-duc-nghe-nghiep.md) | Đạo đức nghề nghiệp của FDE |
| [Phụ lục A](10-Phu-luc-A-chi-so-FDE-can-theo-doi.md) | Các chỉ số phổ biến FDE cần theo dõi |
| [Phụ lục B](11-Phu-luc-B-danh-sach-nhan-vat-va-team-FDE.md) | Danh sách nhân vật và team FDE |
| [Phụ lục C](12-Phu-luc-C-chi-muc-case-va-nguon-tai-lieu.md) | Chỉ mục case và nguồn tài liệu của toàn bộ sách |
